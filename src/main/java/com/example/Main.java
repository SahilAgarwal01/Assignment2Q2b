...
//
    ...
    public static void main(String[] args) throws SQLException, IOException {
        try {
            ...
            String filePath = "C:\\Users\\sahil.agarwal\\Desktop\\Assignment2_sol2\\src\\main\\resources\\Accolite.xlsx";
            List<ExcelData> dataList = parseExcel(filePath);

            insertData(dataList);

            // Step 5: Generate PDF and embed charts
            PdfGenerator.generatePdf(dataList, "C:\\Users\\sahil.agarwal\\Desktop\\Assignment2_sol2\\src\\main\\resources\\Output.pdf");
